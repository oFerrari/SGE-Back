...
INSERT INTO tb_motorista (id, nome, CNH, CPF, endereco, telefone, email, id_veiculo_fk) VALUES (1, 'Carlos Santos', '123456789', '456.789.123-00', 'Praça C, 789', '(33) 5555-1234', 'carlos@example.com',1);
INSERT INTO tb_motorista (id, nome, CNH, CPF, endereco, telefone, email, id_veiculo_fk) VALUES (2, 'João da Silva', '12345678901', '123.456.789-01', 'Rua A 123', '(11) 1234-5678', 'joao.silva@example.com',2);
...
INSERT INTO tb_motorista (id, nome, CNH, CPF, endereco, telefone, email, id_veiculo_fk) VALUES (4, 'Pedro Oliveira', '54321098765', '543.210.987-65', 'Rua C 789', '(33) 2345-6789', 'pedro.oliveira@example.com',4);
